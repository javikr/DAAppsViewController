...
- (void)setAppObject:(DAAppObject *)appObject
{
    ...
    self.ratingsLabel.hidden = (appObject.userRatingCount == 0) || !self.shouldShowRating;
    self.noRatingsLabel.hidden = (appObject.userRatingCount > 0) || !self.shouldShowRating;
    self.starImageView.hidden = (appObject.userRatingCount == 0) || !self.shouldShowRating;
